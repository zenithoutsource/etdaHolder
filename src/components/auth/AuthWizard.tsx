...
import { readPendingCredentialOfferRoute, useDeeplinkStore } from '../../store/deeplinkStore'
...
export function AuthWizard() {
  ...
  async function routeAfterAuth() {
    ...
    router.replace(readPostLoginRoute({ platform: Platform.OS, hasWalletPin: true }))
  }
      ...
      <KeyboardAvoidingView
        ...
        <View className="mb-8">
          ...
          <Text className="mt-2 text-center text-[15px] text-[#6d7a8d]">
            {step === 'login-pin' ? 'Welcome back' : 'Create or access your wallet'}
          </Text>
        </View>
        ...
        {step === 'name' ? (
          <View
            ...
            <Pressable className="items-center" onPress={goToEmailStep}>
              <Text className="text-sm text-[#6d7a8d]">Use a different email</Text>
            </Pressable>
          </View>
        ) : null}

        {step === 'pin-enter' || step === 'pin-confirm' || step === 'login-pin' ? (
          <View className="items-center">
            ...
            <Pressable className="mt-6" onPress={goToEmailStep}>
              <Text className="text-sm text-[#6d7a8d]">Use a different email</Text>
            </Pressable>
          </View>
        ) : null}
