...
export function TrustConfirmationCard({
  ...
  return (
    <View className="flex-1 bg-[#eef1f4] px-10 pt-[60px]">
      <View className="relative min-h-[200px] rounded-lg border-[8px] border-wallet-navy bg-white px-5 pb-6 pt-5">
        ...
        <AppButton variant="solid-block" label={confirmLabel} onPress={onConfirm} className="mt-8 h-9 min-w-[98px] self-center !bg-[#18a05d] px-6" textClassName="text-[13px]" />
      </View>
    </View>
  )
}
