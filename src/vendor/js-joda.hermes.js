...
(function (global, factory) {
    ...
    var ChronoField = function (_TemporalField) {
      ...
      ChronoField.byName = function (fieldName) {
    ...
    var TemporalQuery = function (_Enum) {
      ...
      _proto.queryFrom = function (temporal) {
     ...
     */var EnumMap = function () {
      ...
      _proto.putAll = function (otherMap) {
    ...
    var Temporal = function (_TemporalAccessor) {
      ...
      _proto.minus = function (amount, unit) {
        if (arguments.length < 2) {
      ...
      _proto._minusAmount = function (amount) {
        requireNonNull(amount, 'amount');
        requireInstance(amount, TemporalAmount, 'amount');
        return amount.subtractFrom(this);
      };
      _proto._minusUnit = function (amountToSubtract, unit) {
        requireNonNull(amountToSubtract, 'amountToSubtract');
        requireNonNull(unit, 'unit');
        requireInstance(unit, TemporalUnit, 'unit');
        return this._plusUnit(-amountToSubtract, unit);
      };
      _proto.plus = function (amount, unit) {
        if (arguments.length < 2) {
      ...
      _proto._plusAmount = function (amount) {
        requireNonNull(amount, 'amount');
        requireInstance(amount, TemporalAmount, 'amount');
        return amount.addTo(this);
      };
      _proto._plusUnit = function (amountToAdd, unit) {
        abstractMethodFail('_plusUnit');
      };
      _proto.until = function (endTemporal, unit) {
        abstractMethodFail('until');
      };
      _proto.with = function (adjusterOrField, newValue) {
        if (arguments.length < 2) {
      ...
      _proto._withAdjuster = function (adjuster) {
    ...
    var StringUtil = function () {
      function StringUtil() {}
      StringUtil.startsWith = function (text, pattern) {
    ...
    var Fixed = function (_ZoneRules) {
      ...
      _proto2.isFixedOffset = function () {
        return true;
      };
    ...
    var DateTimeBuilder = function (_TemporalAccessor) {
      ...
      DateTimeBuilder.create = function (field, value) {
      ...
      _proto.getFieldValue0 = function (field) {
    ...
    var DateTimeParseContext = function () {
      ...
      _proto._constructorParam = function (locale, symbols, chronology) {
        this._locale = locale;
    ...
    var SignStyle = function (_Enum) {
      ...
      _proto.parse = function (positive, strict, fixedWidth) {
        switch (this) {
     ...
     */var CompositePrinterParser = function () {
      ...
      _proto.withOptional = function (optional) {
    ...
    var ReducedPrinterParser = function (_NumberPrinterParser) {
      ...
      _proto2._getValue = function (context, value) {
    ...
    var OffsetIdPrinterParser = function () {
      ...
      _proto._checkPattern = function (pattern) {
    ...
    var ZoneRulesProvider = function () {
      ...
      ZoneRulesProvider.getRules = function (zoneId) {
    ...
    var ZoneRegion = function (_ZoneId) {
      ...
      ZoneRegion.ofId = function (zoneId) {
    ...
    var ZoneIdTree = function () {
      ZoneIdTree.createTreeMap = function (availableZoneIds) {
    ...
    var DateTimeFormatterBuilder = function () {
      ...
      _proto.parseCaseSensitive = function () {
      ...
      _proto.parseDefaulting = function (field, value) {
    ...
    var InstantPrinterParser = function () {
      ...
      _proto2.print = function (context, buf) {
    ...
    var DefaultingParser = function () {
      ...
      _proto3.print = function () {
        return true;
      };
      _proto3.parse = function (context, text, position) {
    ...
    var MonthDay = function (_TemporalAccessor) {
      ...
      MonthDay.now = function (zoneIdOrClock) {
    ...
    var YearMonth = function (_Temporal) {
      ...
      YearMonth.now = function (zoneIdOrClock) {
        if (arguments.length === 0) {
    ...
    var DayOfWeekInMonth = function (_TemporalAdjuster2) {
      ...
      _proto2.adjustInto = function (temporal) {
        if (this._ordinal >= 0) {
    ...
    var RelativeDayOfWeek = function (_TemporalAdjuster3) {
      ...
      _proto3.adjustInto = function (temporal) {
    ...
    var IsoChronology = function (_Enum) {
      ...
      IsoChronology.isLeapYear = function (prolepticYear) {
        return (prolepticYear & 3) === 0 && (prolepticYear % 100 !== 0 || prolepticYear % 400 === 0);
      };
      var _proto = IsoChronology.prototype;
      _proto._updateResolveMap = function (fieldValues, field, value) {
    ...
    var OffsetTime = function (_Temporal) {
      ...
      OffsetTime.from = function (temporal) {
        requireNonNull(temporal, 'temporal');
    ...
    var ZonedDateTime = function (_ChronoZonedDateTime) {
      ...
      ZonedDateTime.now = function (clockOrZone) {
        var clock;
      ...
      _proto._resolveLocal = function (newDateTime) {
    ...
    var OffsetDateTime = function (_Temporal) {
      ...
      OffsetDateTime.from = function (temporal) {
        requireNonNull(temporal, 'temporal');
    ...
    var LocalDate = function (_ChronoLocalDate) {
      ...
      LocalDate.now = function (clockOrZone) {
        var clock;
        if (clockOrZone == null) {
      ...
      _proto._atStartOfDayWithZone = function (zone) {
        requireNonNull(zone, 'zone');
    ...
    var LocalDateTime = function (_ChronoLocalDateTime) {
      ...
      LocalDateTime.now = function (clockOrZone) {
        if (clockOrZone == null) {
      ...
      _proto._withDateTime = function (newDate, newTime) {
    ...
    var LocalTime = function (_Temporal) {
      ...
      LocalTime.now = function (clockOrZone) {
        if (clockOrZone == null) {
    ...
    var Instant = function (_Temporal) {
      ...
      Instant.ofEpochMicro = function (epochMicro) {
      ...
      _proto.plusMicros = function (microsToAdd) {
      ...
      _proto.minusMicros = function (microsToSubtract) {
      ...
      _proto._microsUntil = function (end) {
